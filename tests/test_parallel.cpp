...
TEST_CASE("Test Parallel - parallel_sum") {
    ...
    const auto sequential_result = parallel_sum(start, stop, identity, func, false);
...
TEST_CASE("Test Parallel - parallel_sum_2d") {
    ...
    const auto sequential_result = parallel_sum_2d(start1, stop1, start2, stop2, identity, func, false);
