...
TEST_CASE("Test linear algebra - Test Matrix initialisation") {
  SECTION("Test memory initialiser") {
    ...
    for (size_t i = 0; i < n_elem; ++i) {
      ...
      CHECK_THAT(
          linalg::elem(mat, row_index, col_index), WithinAbs(vector[i], margin)
      );
    }
  }
  ...
  SECTION("Test identity matrix") {
    ...
    for (size_t i = 0; i < n * n; ++i) {
      ...
      CHECK_THAT(
          linalg::elem(mat, row_index, col_index), WithinAbs(target, margin)
      );
    }
  }
...
TEST_CASE("Test linear algebra - Test Matrix operations") {
  ...
  SECTION("Check dot product") {
    ...
    for (size_t col_index = 0; col_index < n_col; ++col_index) {
      for (size_t row_index = 0; row_index < n_row; ++row_index) {
        sum += linalg::elem(mat1, row_index, col_index) *
               linalg::elem(mat1, row_index, col_index);
      }
    }
  ...
  SECTION("Check reshape") {
    ...
    for (size_t i = 0; i < n_elem; ++i) {
      ...
      CHECK_THAT(
          linalg::elem(mat1, row_idx1, col_idx1),
  ...
  SECTION("Check pseudoinverse") {
    ...
    for (size_t col_index = 0; col_index < n_row; ++col_index) {
      for (size_t row_index = 0; row_index < n_row; ++row_index) {
        ...
        CHECK_THAT(
            linalg::elem(product, row_index, col_index),
  ...
  SECTION("Submat") {
    ...
    for (size_t col_index = 0; col_index < 8; ++col_index) {
      for (size_t row_index = 0; row_index < 6; ++row_index) {
        CHECK_THAT(
            linalg::elem(mat3, row_index, col_index),
    ...
    for (size_t col_index = 0; col_index < 5; ++col_index) {
      for (size_t row_index = 0; row_index < n_row; ++row_index) {
        CHECK_THAT(
            linalg::elem(mat3, row_index, col_index),
            WithinAbs(
                linalg::elem(mat, row_index, col_index + n_col - 5), margin
            )
        );
      }
    }
    ...
    for (size_t col_index = 0; col_index < n_col; ++col_index) {
      for (size_t row_index = 0; row_index < 5; ++row_index) {
        CHECK_THAT(
            linalg::elem(mat3, row_index, col_index),
            WithinAbs(
                linalg::elem(mat, row_index + n_row - 5, col_index), margin
            )
        );
      }
    }
