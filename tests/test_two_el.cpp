...
TEST_CASE("Test Two Electron term - Closed Shell") {
  ...
  const integrals::ThreeIndexFn three_index_fn =
      [&df_sizes, J30, n_ao](const size_t A) -> linalg::Mat {
  ...
  const auto &[fock, energy] =
      two_el::form_fock_two_el_df(base_integrals, {C}, false, true, 1.0, 0);
  ...
  SECTION("Direct fock") {
    ...
    INFO("Test J3_0 implementation");
    {
      ...
      const auto &[fock2, energy2] =
          two_el::form_fock_two_el_df(base2, active_Co, false, true, 1.0, 0.0);
    ...
    );
    {
      ...
      const auto &[fock2, energy2] =
          two_el::form_fock_two_el_df(base_integrals, Co, true, true, 1.0, 0);
  ...
  SECTION("Indirect fock") {
    ...
    );
    {
      ...
      const auto &[fock3, energy3] =
          two_el::form_fock_two_el_df(base_integrals, Co, true, true, 0, 1.0);
...
TEST_CASE("Test Two Electron term - Open Shell") {
  ...
  SECTION("Direct fock") {
    ...
    INFO("Test J3_0 implementation");
    {
      ...
      const auto &[fock2, energy2] =
          two_el::form_fock_two_el_df(base2, orbitals, false, true, 1.0, 0.0);
  ...
  SECTION("Indirect fock") {
    ...
    INFO("Check empty spin channel");
    {
      ...
      const auto &[fock3, energy3] = two_el::form_fock_two_el_df(
          base_integrals, empty_orb, true, true, 1.0, 1.0
      );
      REQUIRE(fock3.size() == n_spin);
      ...
      {
        const auto &[fock4, energy4] = two_el::form_fock_two_el_df(
            base_integrals, empty_orb, true, true, 0, 1.0
        );
        REQUIRE(fock4.size() == n_spin);
