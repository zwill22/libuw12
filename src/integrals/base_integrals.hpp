...
class BaseIntegrals {
 public:
  ...
  /// Constructor used if the standard three-index integrals `J3_0` and the
  /// two-index density-fitting integrals are already calculated. As well as the
  /// ri integrals J3_ri_0. In this case, `J2` is immediately decomposed into
  /// `P2` and `df_vals`, and `J3_0` is stored.
  BaseIntegrals(
